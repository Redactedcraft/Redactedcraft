...
public sealed class VoxelWorld
{
    ...
    public IEnumerable<VoxelChunkData> AllChunks() => _chunks.Values;

    public bool TryGetChunk(ChunkCoord coord, out VoxelChunkData? chunk) => _chunks.TryGetValue(coord, out chunk);
    ...
    public void UnloadChunks(HashSet<ChunkCoord> keep)
    {
