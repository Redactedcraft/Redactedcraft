...
public sealed class OptionsScreen : IScreen
{
    ...
    // Controls binding
    private readonly List<string> _bindOrder = new() { "MoveUp","MoveDown","MoveLeft","MoveRight","Jump","Inventory","Pause" };
    ...
    public void OnResize(Rectangle viewport)
    {
        ...
        _controlsListRect = new Rectangle(contentX, contentY + 60, Math.Min(620, contentW), 300);
    ...
    private void DrawPacks(SpriteBatch sb)
    {
        var scroll = GetScrollOffset();
        var listRect = ScrollRect(_packsListRect, scroll);
        _font.DrawString(sb, "PACKS (Documents/RedactedCraft/Assets/packs)", new Vector2(listRect.X, listRect.Y - _font.LineHeight), Color.White);
