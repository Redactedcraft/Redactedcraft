...
public sealed class CreateWorldScreen : IScreen
{
    ...
    private const int DefaultWorldHeight = 16;
    ...
    private void CreateWorld()
    {
        ...
        try
        {
            ...
            _menus.Pop();
            _menus.Push(
                new WorldGenerationScreen(_menus, _assets, _font, _pixel, _log, _profile, _graphics, name, mode, worldPath, metaPath, _onCreated, enterWorldOnComplete: _enterWorldAfterCreate),
                viewport);
        }
        catch (Exception ex)
        {
