...
path = r"C:\Users\Redacted\Documents\redactedcraft.github.io\vr\index.html"
html = """<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
  ...
  <body>
    <a-scene>
      ...
      <a-entity position="0 1.5 -2">
        ...
        <a-text value="REDACTEDCRAFT VR PORTAL" align="center" position="0 0.7 0" color="#e9b96e" width="4"></a-text>
